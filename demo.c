...
/*
	// (vertical) up-right arrow
	TextData2[0]  = 0x190d073f; // top half
	TextData2[1]  = 0x40602031;
	TextData2[2]  = 0x30206040; // bottom half
	TextData2[3]  = 0x02060c18;	

	// (vertical) up-left arrow
	TextData2[4]  = 0x98b0e0fc; // top half
	TextData2[5]  = 0x0206048c; 
	TextData2[6]  = 0x0c040602; // bottom half
	TextData2[7]  = 0x40603018; 

	// (vertical) down-right arrow
	TextData2[8]  = 0x180c0602; // top half
	TextData2[9]  = 0x40602030; 
	TextData2[10] = 0x31206040; // bottom half
	TextData2[11] = 0x3f070d19; 

	// (vertical) down-left arrow
	TextData2[12] = 0x18306040; // top half
	TextData2[13] = 0x0206040c; 
	TextData2[14] = 0x80060602; // bottom half
	TextData2[15] = 0xfce0b098;  

	// (horizontal) up-right arrow 
	TextData2[16] = 0x180e0300; // left half
	TextData2[17] = 0x00c06030; 
	TextData2[18] = 0x1971c000; // right half
	TextData2[19] = 0x1f03070d;

	// (horizontal) up-left arrow
	TextData2[20] = 0x988e0300; // left half
	TextData2[21] = 0xb0e0c0f8;
	TextData2[22] = 0x1870c000; // rigth half
	TextData2[23] = 0x0003060c;

	// (horizontal) down-right arrow
	TextData2[24] = 0x3060c000; // left half
	TextData2[25] = 0x00030e18;
	TextData2[26] = 0x0d07031f; // right half
	TextData2[27] = 0x00c07119;

	// (horizontal) down-left arrow
	TextData2[28] = 0xb0e0c0f1; // left half
	TextData2[29] = 0x00038e98;
	TextData2[30] = 0x0c060300; // right half
	TextData2[31] = 0x00c07018;

	//Unused
	int p = 32;
	for (; p < 64; p++) {
		TextData2[p] = 0x00000000;
	}
*/
	XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);

	//Create Instructions
	u32 InstSetPtr[28]; //Instructions are 4-words
	...
	//Arrow (Upper and Lower Strings) - LEFT HAND
	XOsd_CreateInstruction(&xosd_inst, InstSetPtr+12, 1, XOSD_INS_OPCODE_TXT, 0x80, 0x1A9, 0xF0, 0x229, 0xF0, 0x3, 0x2);
	XOsd_CreateInstruction(&xosd_inst, InstSetPtr+16, 1, XOSD_INS_OPCODE_TXT, 0x80, 0x1A9, 0x130, 0x229, 0x130, 0x4, 0x2);

	//Arrow (Upper and Lower Strings) - RIGHT HAND
	XOsd_CreateInstruction(&xosd_inst, InstSetPtr+20, 1, XOSD_INS_OPCODE_TXT, 0x80, 0x320, 0xF0, 0x3A0, 0xF0, 0x5, 0x4);
	XOsd_CreateInstruction(&xosd_inst, InstSetPtr+24, 1, XOSD_INS_OPCODE_TXT, 0x80, 0x320, 0x130, 0x3A0, 0x130, 0x6, 0x4);
	...
	//DemoRun();
	WAIT: while (!XUartLite_IsReceiveEmpty(UART_BASEADDR))
	{
	...
	while (userInput != 'q')
		{
			...
			case '1':
				...
				case 5: TextData[8] = 0x00001e0b; score++; break;
				...
				case 15: TextData[8] = 0x00001e0e; score++; break;
			...
			case '3':
				...
				break;
			case '4':
				//Display Two Right Arrows
				TextData[24] = 0x00001f1a;
				TextData[32] = 0x00000000;
				TextData[40] = 0x00001f1a;
				TextData[48] = 0x00000000;
				XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
			...
			case '6':
				...
				TextData[40] = 0x0000001b;
				TextData[48] = 0x0000001d;
				XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
			...
			case '7':
				...
				TextData[40] = 0x0000001d;
				TextData[48] = 0x0000001c;
				XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
				...
				break;
			case 'u':
				// display (vertical) up-right arrow
				
				break;
			case 'i':
				// display (vertical) up-left arrow
				
				break;
			case 'o':
				// display (vertical) down-right arrow
				
				break;
			case 'p':
				// display (vertical) down-left arrow
				
				break;
			case 'h':
				// display (horizontal) up-right arrow
				
				break;
			case 'j':
				// display (horizontal) up-left arrow
				
				break;
			case 'k':
				// display (horizontal) down-right arrow
				
				break;
			case 'l':
				// display (horizontal) down-left arrow
				
				break;
			case 't':
				//Test
				COLORDETECT2_mWriteReg(XPAR_COLORDETECT2_0_S00_AXI_BASEADDR, COLORDETECT2_S00_AXI_SLV_REG1_OFFSET, 0x026e9650);
				xil_printf("Writing to MotionDetector\r\n");
				MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00000009);
				xil_printf("Reading from MotionDetector\r\n");
				while((COLORDETECT2_mReadReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG1_OFFSET) & 0x1) == 0) {
					MB_Sleep(500);
					//xil_printf("Reading Color 1 Coordinates: %x\r\n", COLORDETECT2_mReadReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG2_OFFSET));
					xil_printf("Reading Color 2 Coordinates: %x\r\n", COLORDETECT2_mReadReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG3_OFFSET));
				}
				xil_printf("%d", (COLORDETECT2_mReadReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG1_OFFSET) & 0x1f));
				break;
			case 'x':
	...
	int movement[2]; // [left hand, right hand, left leg, right leg]
	...
	// display "score 0" on screen, no good/bad, no movement instruction
	...
	while(1){
		...
		movement[0] = getNewMove(prev_movement[0]);
		movement[1] = getNewMove(prev_movement[1]);
		//movement[2] = getNewMove(prev_movement[2]);
		//movement[3] = getNewMove(prev_movement[3]);

		u32 value_to_write = 0x9;
		...
		for(k = 0; k < 2; k++) {
			...
			switch(movement[k]) {
				case 0:	// right arrow
					...
					XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);	
//					XOsd_CreateInstruction(&xosd_inst, );
//					XOsd_LoadInstructionList(&xosd_inst, );
					xil_printf("Writing to Color %d Move Right to MotionDetector\r\n", k);
//					MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00000001);
					break;
				case 1: // left arrow
					if (k == 0) {
						TextData[24] = 0x00001a19;
						TextData[32] = 0x00000000;
						value_to_write = value_to_write + 0x10000;
					} else {
						TextData[40] = 0x00001a19;
						TextData[48] = 0x00000000;
						value_to_write = value_to_write + 0x100000;
					}
					XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
//					XOsd_CreateInstruction(&xosd_inst, );
//					XOsd_LoadInstructionList(&xosd_inst, );
					xil_printf("Writing to Color %d Move Left to MotionDetector\r\n", k);
//					MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00010001);
					break;
				case 2: // up arrow
					if (k == 0) {
						TextData[24] = 0x0000001b;
						TextData[32] = 0x0000001d;
						value_to_write = value_to_write + 0x20000;
					} else {
						TextData[40] = 0x0000001b;
						TextData[48] = 0x0000001d;
						value_to_write = value_to_write + 0x200000;
					}
					XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
//					XOsd_CreateInstruction(&xosd_inst, );
//					XOsd_LoadInstructionList(&xosd_inst, );
					xil_printf("Writing to Color %d Move Up to MotionDetector\r\n", k);
//					MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00020001);
					break;
				case 3: // down arrow
					if (k == 0) {
						TextData[24] = 0x0000001d;
						TextData[32] = 0x0000001c;
						value_to_write = value_to_write + 0x30000;
					} else {
						TextData[40] = 0x0000001d;
						TextData[48] = 0x0000001c;
						value_to_write = value_to_write + 0x300000;
					}
					XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
//					XOsd_CreateInstruction(&xosd_inst, );
//					XOsd_LoadInstructionList(&xosd_inst, );
					xil_printf("Writing to Color %d Move Down to Motion	Detector\r\n", k);
//					MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00020001);
					break;
				case 4: // vertical up-right arrow
					XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
//					XOsd_CreateInstruction(&xosd_inst, );
//					XOsd_LoadInstructionList(&xosd_inst, );
					xil_printf("Writing to Color %d Move Vertical Up-Right to Motion Detector\r\n", k);
//					MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00020001);
					break;
				case 5: // vertical up-left arrow
					XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
//					XOsd_CreateInstruction(&xosd_inst, );
//					XOsd_LoadInstructionList(&xosd_inst, );
					xil_printf("Writing to Color %d Move Vertical Up-Left to Motion Detector\r\n", k);
//					MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00020001);
					break;
				case 6: // vertical down-right arrow
					XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
//					XOsd_CreateInstruction(&xosd_inst, );
//					XOsd_LoadInstructionList(&xosd_inst, );
					xil_printf("Writing to Color %d Move Vertical Down-Right to Motion Detector\r\n", k);
//					MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00020001);
					break;
				case 7:	// vertical down-left arrow
					XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
//					XOsd_CreateInstruction(&xosd_inst, );
//					XOsd_LoadInstructionList(&xosd_inst, );
					xil_printf("Writing to Color %d Move Vertical Down-Left to Motion Detector\r\n", k);
//					MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00020001);
					break;
				case 8: // horizontal up-right arrow
					XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
//					XOsd_CreateInstruction(&xosd_inst, );
//					XOsd_LoadInstructionList(&xosd_inst, );
					xil_printf("Writing to Color %d Move Horizontal Up-Right to Motion Detector\r\n", k);
//					MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00020001);
					break;
				case 9: // horizontal up-left arrow
					XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
//					XOsd_CreateInstruction(&xosd_inst, );
//					XOsd_LoadInstructionList(&xosd_inst, );
					xil_printf("Writing to Color %d Move Horizontal Up-Left to Motion Detector\r\n", k);
//					MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00020001);
					break;
				case 10: // horizontal down-right arrow
					XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
//					XOsd_CreateInstruction(&xosd_inst, );
//					XOsd_LoadInstructionList(&xosd_inst, );
					xil_printf("Writing to Color %d Move Horizontal Down-Right to Motion Detector\r\n", k);
//					MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00020001);
					break;
				case 11: // horizontal down-left arrow
					XOsd_LoadTextBank(&xosd_inst, 1, 1, TextData);
//					XOsd_CreateInstruction(&xosd_inst, );
//					XOsd_LoadInstructionList(&xosd_inst, );
					xil_printf("Writing to Color %d Move Horizontal Down-Left to Motion Detector\r\n", k);
//					MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00020001);
					break;
				default: // no movement
					// remove display
...
//					XOsd_CreateInstruction(&xosd_inst, );
//					XOsd_LoadInstructionList(&xosd_inst, );
					xil_printf("Writing to Color %d Move <NONE> to Motion Detector\r\n", k);
//					MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, 0x00020001);
					break;
			}
		}

		MOTIONDEIP_mWriteReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG0_OFFSET, value_to_write);
		xil_printf("Writing value %x to MotionDetector\r\n", value_to_write);
		xil_printf("Reading from MotionDetector\r\n");
		while((COLORDETECT2_mReadReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG1_OFFSET) & 0x1) == 0) {
			MB_Sleep(500);
			xil_printf("Reading Coordinates: %x\r\n", COLORDETECT2_mReadReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG2_OFFSET));
		...
		xil_printf("%d", (COLORDETECT2_mReadReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG1_OFFSET) & 0x1f));
		if ((COLORDETECT2_mReadReg(XPAR_MOTIONDEIP_0_S00_AXI_BASEADDR, MOTIONDEIP_S00_AXI_SLV_REG1_OFFSET) & 0x1) == 1) {
			//Display Good
			TextData[16] = 0x050b0b09;
			switch (score)
			{
